...
*/
	...
	//------------------------------ (AQ) Setup Actions	   Set Points��ZRO, PRD, CAU, CAD, CBU, CBD
	...
	EPwm1Regs.PCCTL.bit.OSHTWTH = 0xF;				// One-shot pulse width = N �� EPWMCLK*8��N =��0x0~0xF��
...
*/
	...
	EPwm2Regs.PCCTL.bit.OSHTWTH = 0xF;				// One-shot pulse width = N �� EPWMCLK*8��N =��0x0~0xF��
...
*/
	...
	EPwm3Regs.PCCTL.bit.OSHTWTH = 0xF;				// One-shot pulse width = N �� EPWMCLK*8��N =��0x0~0xF��
...
void usr_ePWM7_Setup(void)
{
	...
	EPwm7Regs.PCCTL.bit.OSHTWTH = 0xF;				// One-shot pulse width = N �� EPWMCLK*8��N =��0x0~0xF��
...
void usr_ePWM8_Setup(void)
{
	...
	EPwm8Regs.PCCTL.bit.OSHTWTH = 0xF;				// One-shot pulse width = N �� EPWMCLK*8��N =��0x0~0xF��
...
void usr_ePWM9_Setup(void)
{
	...
	EPwm9Regs.PCCTL.bit.OSHTWTH = 0xF;				// One-shot pulse width = N �� EPWMCLK*8��N =��0x0~0xF��
...
void usr_ePWM10_Setup(void)
{
	...
	EPwm10Regs.PCCTL.bit.OSHTWTH = 0xF;				// One-shot pulse width = N �� EPWMCLK*8��N =��0x0~0xF��
